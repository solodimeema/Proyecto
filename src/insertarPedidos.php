<?php 
    ...
    if(mysqli_connect_errno()){
        ...
        if(isset($_POST['btnAdd'])){
            $registrar = "INSERT INTO Pedidos(user,Codigo,Descripcion,Marca,Color,Talla,Cantidad) 
            VALUES('$user','$codigo','$descripcion','$marca','$color','$numero','$cantidad')";
